...
require 'basecrm/models/sync_device'
...
require 'basecrm/services/sync_devices_service'
...
module BaseCRM
  class Client
    ...
    # Access all SyncDevices related actions. 
    # @see SyncDevicesService 
    # @see SyncDevice
    # 
    # @return [SyncDevicesService] Service object for  resources.
    def sync_devices
      @sync_devices ||= SyncDevicesService.new(@http_client)
    end
